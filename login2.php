      ...
      <div class="tab-content">
        ...
        <div id="signup">
          ...
          <div class="top-row">
            <div class="field-wrap">
              ...
              <input type="text" name="fname" pattern="[A-Za-z\s]{1,50}" title="Please enter Alphabets (Max 50 characters)" required autocomplete="off" />
            </div>
            ...
            <div class="field-wrap">
              ...
              <input type="text" name="lname" pattern="[A-Za-z\s]{1,50}" title="Please enter Alphabets (Max 50 characters)" required autocomplete="off"/>
            </div>
          </div>
          ...
          <div class="field-wrap">
            ...
            <input type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="Please enter an email address" required autocomplete="off"/>
          </div>
            ...
            <input type="text" name="uname" pattern="[A-Za-z0-9_]{1,20}$" title="Username max 20 characters, cannot contain special characters" required autocomplete="off"/>
          </div>
          ...
          <div class="field-wrap">
            ...
            <input type="text" name="ssa"  title="Please enter Address (Max 100 characters)" required autocomplete="off"/>
          </div>
          ...
          <div class="field-wrap">
            <select name="ss" class="w3-text-white" required>
          ...
          <div class="field-wrap">
            ...
            <input type="text" name="bsa"  title="Please enter Address (Max 100 characters)" required autocomplete="off"/>
          </div>
          ...
          <div class="field-wrap">
            <select name="bs" class="w3-text-white" required>
            <option value="" disabled selected>State</option>
            <?php
          ...
          <div class="field-wrap">
            ...
            <br>
                ...
                <span> <?php
                               ...
                               if($f==1){
                                 echo '<div class="w3-alert w3-alert-danger w3-text-center w3-text-white">Username already in use. Please be more creative! <i class="fa fa-smile-o"></i></div>';
                               }
                             ?> </span>
        ...
        <div id="login">
          ...
          <form action="logincheck.php" method="post">
            ...
            <input type="text" name="form-username" required autocomplete="off"/>
          </div>
          ...
          <div class="field-wrap">
            ...
            <input type="password" name="form-password" required autocomplete="off"/>
          </div>

           <span> <?php
                               if($flag==1){
                                 echo '<div class="w3-alert w3-alert-danger w3-text-center w3-text-red">Invalid Username or Password</div>';
                               }
