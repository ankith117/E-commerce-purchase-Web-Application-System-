...
$sql= "SELECT * FROM `item catalog` WHERE `Category`='Shirts' AND `Sub Category`='Men'";
  ...
  <div class="w3-padding-64 w3-large w3-text-white" style="font-weight:bold">
    ...
    <div class="w3-accordion">
     <a onclick="myAccFunc()" href="javascript:void(0)" class="w3-text-white" id="myBtn">
        Shirts <i class="fa fa-caret-down w3-text-white w3-margin-left-min"></i>
    </a>
      <div id="demoAcc" class="w3-accordion-content w3-padding-large w3-medium">
        <a href="aindex.php" class="w3-black"><i class="fa fa-caret-right w3-margin-right"></i>Men</a>
        <a href="asw.php">Women</a>
        <a href="ask.php">Kids</a>
      </div>
    </div>
      <a href="ajm.php">Jeans</a>
      <a href="ashm.php">Shoes</a>
    </div>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-container w3-xlarge" style="background-color: black;margin:0px 0px 10px 0px;">
    <p class="w3-left w3-text-white">Shirts</p>
    <p class="w3-left w3-text-white" style="margin-left: 340px">admin <a href="admin.php"> <i class="fa fa-user"></i></a> </p>
    <p class="w3-right">
      ...
      <a title="Update/Delete" href="#"> <i class="fa fa-user-plus w3-text-white"></i></a>
  </p>
  </div>

  <!-- Image header=================================================================================================== -->
  <div class="w3-display-container w3-container">
    <img src=sm1.jpg alt="Jeans" style="width:100%">
    ...
    echo'<div class="w3-col l3 s6">
      <div class="w3-container w3-left">
        ...
        if($itq==0){ echo'<button class="w3-btn">Out of Stock <i class="fa fa-frown-o"></i></button>';}
            else{ echo '<a href="add.php?msg1='.$sku.'&msg2=shm"><button class="w3-btn">Add to cart <i class="fa fa-shopping-cart"></i></button></a>';}
          echo '</div>
        </div>
        <h4>'.$itn.'<br></h4>
...
<div id="ship" class="w3-modal">
  <div class="w3-modal-content w3-animate-zoom w3-padding-jumbo">
    <div class="w3-container w3-white w3-center">
      ...
      <p><input class="w3-input w3-border" type="text" placeholder="Shipping ID"></p>
      <a href="#"><button type="button" class="w3-btn w3-padding-large w3-green w3-text-white w3-margin-bottom" onclick="document.getElementById('ship').style.display='none'">Track Order</button></a>
    </div>
  </div>
</div>
