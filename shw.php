...
$sql= "SELECT * FROM `item catalog` WHERE `Category`='Shoes' AND `Sub Category`='Women'";
...
<nav class="w3-sidenav w3-teal w3-collapse w3-top" style="z-index:3;width:250px;margin-left:0px;" id="mySidenav">
  ...
  <div class="w3-padding-64 w3-large w3-text-white" style="font-weight:bold">
      ...
      <a href="jm.php">Jeans</a>

      <div class="w3-accordion">
     <a onclick="myAccFunc()" href="javascript:void(0)" class="w3-text-white" id="myBtn">
        Shoes <i class="fa fa-caret-down w3-text-white w3-margin-left-min"></i>
    </a>
      <div id="demoAcc" class="w3-accordion-content w3-padding-large w3-medium">
        <a href="shm.php">Men</a>
        <a href="shw.php" class="w3-black"><i class="fa fa-caret-right w3-margin-right"></i>Women</a>
        <a href="shk.php">Kids</a>
      </div>
    </div>
    </div>

  <a href="#team" class="w3-padding">Contact</a>
    <a href="javascript:void(0)" class="w3-padding" onclick="document.getElementById('ship').style.display='block'">Track your order</a>
  <a href="javascript:void(0)"  class="w3-padding" onclick="document.getElementById('newsletter').style.display='block'">Subscribe</a>
</nav>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- Top header ===================================================================================================-->
  <header class="w3-container w3-xlarge" style="background-color: black;margin:0px 0px 10px 0px;">
    <p class="w3-left w3-text-white">Shoes</p>
    <p class="w3-right">
      ...
      <i class="fa fa-shopping-cart w3-margin-right w3-text-white"></i>
        ...
        <a title="login" href="login1.php" > <i class="fa fa-sign-in w3-text-white"></i></a>
    </p>
  </header>

  <!-- Image header=================================================================================================== -->
  <div class="w3-display-container w3-container">
    <img src=shw.jpg alt="Jeans" style="width:100%">
    <div class="w3-display-topright w3-padding-xxlarge w3-text-white">
    ...
    echo'<div class="w3-col l3 s6">
      <div class="w3-container w3-left">
        ...
        <div class="w3-display-middle w3-display-hover">
            <a href="javascript:void(0)" onclick="'; echo " document.getElementById('newsletter').style.display='block'";echo'"><button class="w3-btn">Add to cart <i class="fa fa-shopping-cart"></i></button></a>
          </div>
        </div>
        <h4>'.$itn.'<br></h4>
...
<div id="ship" class="w3-modal">
  <div class="w3-modal-content w3-animate-zoom w3-padding-jumbo">
    <div class="w3-container w3-white w3-center">
      ...
      <p>Please enter your shipping ID</p>
      <form action="track.php" method="post">
      <p><input class="w3-input w3-border" name="shid" type="text" placeholder="Shipping ID"></p>
