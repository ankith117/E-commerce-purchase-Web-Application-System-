...
<nav class="w3-sidenav w3-teal w3-collapse w3-top" style="z-index:3;width:250px;margin-left:0px;" id="mySidenav">
  ...
  <div class="w3-padding-64 w3-large w3-text-white" style="font-weight:bold">
      ...
      <a href="lindex.php">Shirts</a>
      <a href="ljm.php">Jeans</a>
     ...
     <a onclick="myAccFunc()" href="javascript:void(0)" class="w3-text-white" id="myBtn">
      ...
      <div id="demoAcc" class="w3-accordion-content w3-padding-large w3-medium">
        <a href="lshm.php">Men</a>
        <a href="lshw.php" class="w3-black"><i class="fa fa-caret-right w3-margin-right"></i>Women</a>
        <a href="lshk.php">Kids</a>
      </div>
    </div>
    </div>

  <a href="#team" class="w3-padding">Contact</a>
    <a href="javascript:void(0)" class="w3-padding" onclick="document.getElementById('order').style.display='block'">View your order</a>
    <a href="javascript:void(0)" class="w3-padding" onclick="document.getElementById('ship').style.display='block'">Track your order</a>
    <a href="javascript:void(0)" class="w3-padding" onclick="document.getElementById('sub').style.display='block'">Edit Subscription Template</a>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-container w3-xlarge" style="background-color: black;margin:0px 0px 10px 0px;">
    ...
    <p class="w3-right">
      ...
      <a href="cart.php"><i class="fa fa-shopping-cart w3-margin-right w3-text-white"></i></a>
    ...
    echo'<div class="w3-col l3 s6">
      <div class="w3-container w3-left">
        ...
        if($itq==0){ echo'<button class="w3-btn">Out of Stock <i class="fa fa-frown-o"></i></button>';}
            else{ echo '<a href="add.php?msg1='.$sku.'&msg2=shw"><button class="w3-btn">Add to cart <i class="fa fa-shopping-cart"></i></button></a>';}
          echo '</div>
        </div>
        <h4>'.$itn.'<br></h4>
