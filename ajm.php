...
$sql= "SELECT * FROM `item catalog` WHERE `Category`='Jeans' AND `Sub Category`='Men'";
  ...
  <div class="w3-padding-64 w3-large w3-text-white" style="font-weight:bold">
    ...
    <div class="w3-accordion">
      ...
      <div id="demoAcc" class="w3-accordion-content w3-padding-large w3-medium">
        <a href="ajm.php" class="w3-black"><i class="fa fa-caret-right w3-margin-right"></i>Men</a>
        <a href="ajw.php">Women</a>
