    ...
    <div class="w3-accordion">
     <a onclick="myAccFunc()" href="javascript:void(0)" class="w3-text-white" id="myBtn">
      ...
      <div id="demoAcc" class="w3-accordion-content w3-padding-large w3-medium">
        <a href="lindex.php">Men</a>
        <a href="lsw.php" class="w3-black"><i class="fa fa-caret-right w3-margin-right"></i>Women</a>
        <a href="lsk.php">Kids</a>
      </div>
    </div>
      <a href="ljm.php">Jeans</a>
      <a href="lshm.php">Shoes</a>
    </div>
    ...
    echo'<div class="w3-col l3 s6">
      <div class="w3-container w3-left">
        ...
        if($itq==0){ echo'<button class="w3-btn">Out of Stock <i class="fa fa-frown-o"></i></button>';}
            else{ echo '<a href="add.php?msg1='.$sku.'&msg2=sw"><button class="w3-btn">Add to cart <i class="fa fa-shopping-cart"></i></button></a>';}
          echo '</div>
        </div>
        <h4>'.$itn.'<br></h4>
