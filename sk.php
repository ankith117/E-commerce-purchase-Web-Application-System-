...
$sql= "SELECT * FROM `item catalog` WHERE `Category`='Shirts' AND `Sub Category`='Kids'";
    ...
    <div class="w3-accordion">
     <a onclick="myAccFunc()" href="javascript:void(0)" class="w3-text-white" id="myBtn">
      ...
      <div id="demoAcc" class="w3-accordion-content w3-padding-large w3-medium">
        ...
        <a href="sw.php">Women</a>
        <a href="sk.php" class="w3-black"><i class="fa fa-caret-right w3-margin-right"></i>Kids</a>
      </div>
    </div>
      <a href="jm.php">Jeans</a>
      <a href="shm.php">Shoes</a>
    </div>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-display-container w3-container">
    <img src=sk.jpg alt="Jeans" style="width:100%">
