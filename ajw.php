...
$sql= "SELECT * FROM `item catalog` WHERE `Category`='Jeans' AND `Sub Category`='Women'";
  ...
  <div class="w3-padding-64 w3-large w3-text-white" style="font-weight:bold">
    ...
    <div class="w3-accordion">
      ...
      <div id="demoAcc" class="w3-accordion-content w3-padding-large w3-medium">
        <a href="ajm.php" >Men</a>
        <a href="ajw.php"class="w3-black"><i class="fa fa-caret-right w3-margin-right"></i>Women</a>
        <a href="ajk.php">Kids</a>
      </div>
    </div>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-display-container w3-container">
    <img src=wjj.jpg alt="Jeans" style="width:100%">
